...
//				IHelpConstants.CONEXT_ID_DATASOURCE_EXCEL);
            ...
            public void modifyText( ModifyEvent e )
            {
             ...
             this.dataList = new Tree(composite, 2048);
                  ...
                  this.dataList.addSelectionListener(new SelectionListener()
                  {
                    ...
                    public void widgetSelected(SelectionEvent e)
                    {
                      TreeItem ti = CustomDataSetWizardPage.this.dataList.getSelection()[0];
                      ...
                      while (ti.getParentItem() != null)
                     {
                      ...
                      CustomDataSetWizardPage.this.m_queryTextField.setText(ti.getText());
                    }
                  });
	...
	private void savePage( DataSetDesign dataSetDesign )
	{
        ...
        try
        {
             ...
             */
            IDriver customDriver = new org.eclipse.rmf.reqif10.pror.report.oda.impl.Driver();
